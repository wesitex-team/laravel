    ...
    <div class="sidebar sidebar-dark sidebar-fixed border-end" id="sidebar">
        <div class="sidebar-header border-bottom">
            <div class="sidebar-brand">
                ...
                <div class="sidebar-brand-narrow fw-bold text-white">HP</div>
            </div>
        ...
        <ul class="sidebar-nav" data-coreui="navigation" data-simplebar>
            ...
            <li class="nav-item">
                <a class="nav-link" href="#">
                    <svg class="nav-icon">
                        <use xlink:href="https://cdn.jsdelivr.net/npm/@coreui/icons@3.0.1/sprites/free.svg#cil-calendar-check"></use>
                    </svg> Leave
                </a>
            </li>
        </ul>
        ...
        <header class="header header-sticky p-0 mb-4">
            <div class="container-fluid border-bottom px-4">
                ...
                <ul class="header-nav d-none d-lg-flex">
                    <li class="nav-item"><a class="nav-link" href="{{ route('hr.dashboard') }}">Dashboard</a></li>
